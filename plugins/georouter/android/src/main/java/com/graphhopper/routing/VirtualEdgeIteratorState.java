...
/**
 * Creates an edge state decoupled from a graph where nodes, pointList, etc are
 * kept in memory.
 * <p>
 * Note, this class is not suited for public use and can change with minor
 * releases unexpectedly or even gets removed.
 */
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    public VirtualEdgeIteratorState(int originalEdgeKey, int edgeId, int baseNode, int adjNode, double distance,
            IntsRef edgeFlags, PointList pointList, boolean reverse) {
    ...
    /**
     * This method sets edge to unfavored status for routing from the start or to
     * the stop location.
     */
    ...
    /*
     * @Override public int getMergeStatus(int flags) { throw new
     * UnsupportedOperationException("Not supported."); }
     * 
     * @Override public int getSkippedEdge1() { throw new
     * UnsupportedOperationException("Not supported."); }
     * 
     * @Override public int getSkippedEdge2() { throw new
     * UnsupportedOperationException("Not supported."); }
     */
    @Override
    ...
    /*
     * @Override public void setFlagsAndWeight(int flags, double weight) { throw new
     * UnsupportedOperationException("Not supported"); }
     * 
     * @Override public double getWeight() { throw new
     * UnsupportedOperationException("Not supported."); }
     */
