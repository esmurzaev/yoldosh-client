 ...
 * To ensure that the id is unique use a Directory.attach or findAttach, if you
 ...
 * create or loadExisting, (4) usage and calling ensureCapacity if necessary,
 * (5) close
 * <p>
 *
 * @author Peter Karich
...
public interface DataAccess extends Storable<DataAccess> {
    ...
    /**
     * Renames the underlying DataAccess object. (Flushing shouldn't be necessary
    ...
    /**
     * Ensures that the capacity of this object is at least the specified bytes. The
     * first time you have to call 'create' instead.
     * <p>
     *
    ...
    /**
     * Reduces the allocate space to the specified bytes. Warning: it'll free the
     * space even if it is in use!
     */
