...
func handleDriver(conn *net.TCPConn) {
	...
	for {
		...
		case 0x14: // Route match search
			...
			node := nodes[nodesSeq]
			// TODO
			// fmt.Println("Driver node: ", node)

			if !pointedClientsFlagGet(node) {
				continue // break
			}
			// TODO
			// fmt.Println("Client point found")
			...
			for i := nodesNum; i > nodesSeq; i-- {
				...
				// TODO
				// fmt.Println("Client route found!")
		...
		case 0x11: // Route nodes set
			...
			// TODO
			// fmt.Println("Driver nodes: ", nodes)
			// fmt.Println("Request successfully")
			// fmt.Println("Connected drivers num: ", driversNum.get())
